...
A Project Director is one of five Rust Project members who serve on the Board of Directors[^directors] of the Rust Foundation to represent the interests of the Rust Project[^establishment]. Project Directors are elected per the [Project Director Election Process].
...
In addition, as the group responsible for the Project's relationship with the Foundation, the Project Directors must also ensure that the Foundation's needs from the Project are being met. For example, if there are issues in the Project impeding the Foundation's engineering efforts, then the Project Directors can work with the relevant teams and the Leadership Council to resolve these.

Similarly, as the Project Directors must approve of any significant course of action taken by the Foundation in board meetings, the Project bears some responsibility for the actions of the Foundation. Therefore, the Project Directors should also be responsible for ensuring that the Project Directors decisions and the Foundation's actions are explained and communicated to the Project's membership at large.

In summary, Project Directors are..
...
- **..responsible for:** the Project's relationship with the Rust Foundation
  ...
  - Assisting the Foundation in their communication with the Project.
...
- **..expected to consult:** the Foundation staff, the Leadership Council, relevant team leads and project members
  ...
  - As appropriate when expertise is required that the Project Directors do not possess.
...
- **..expected to keep informed:** the Project Directors
...
- **..expected to consult:** the Project Directors
  - Communicating the Foundation's needs of the Project with the Project Directors
  - Notifying the Project Directors of any items which may require broader consultation with the LC in a timely manner
...
- Project directors must disclose their name on the Foundation's IRS Form 990, which is a public document. For an example, see the [Foundation's IRS Form 990 for 2023].
...
[Section 4.5]: https://rustfoundation.org/policy/bylaws/#section-4.5-resignation-and-removal
[Project Director Election Process]: ../policies/project-directorship/election-process.md
