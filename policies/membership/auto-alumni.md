...
Once a year, the Council will ensure communication is sent out to every person in rust-lang/team (excluding those who are only alumni). This communication will, in addition to any other questions, inform respondents which teams they are *currently listed* as a part of. The survey will invite a response of "Please remove me from $TEAMS teams." This question will be independent of any other questions on the survey; that is, it should not inhibit responses to other items.
