...
During the meeting, observers should not speak unless specifically invited to do so by the facilitator, and they should mute their audio and video. Observers may send chat messages, and are encouraged to do so if they have important context to add that may be helpful to the council and is of immediate concern, but are also asked to be judicious about such messages so as to avoid distractions. Please note in particular our [meeting decorum](synchronous-meetings.md#meeting-decorum) policy that discourages side conversations in chat. Note also that the members may not read or acknowledge messages sent in chat, and so information of importance should be additionally conveyed using some other channel.
